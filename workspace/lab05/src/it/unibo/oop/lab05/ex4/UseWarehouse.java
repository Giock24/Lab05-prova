...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
    	final Product p1 = new ComparableProduct("Banana", 10.0);
        final Product p2 = new ComparableProduct("Apple", 5.0);
        final Product p3 = new ComparableProduct("Meat", 20.0);

        final Warehouse w = new OrderedWarehouse("Giock's Warehouse");
        w.addProduct(p3);
        w.addProduct(p1);
        w.addProduct(p2);
