...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
        ...
        final Product p1 = new ProductImpl("Potato", 10.0);
        final Product p2 = new ProductImpl("Water", 5.0);
        final Product p3 = new ProductImpl("Meat", 20.0);

        final Warehouse w = new WarehouseImpl("Giock's Warehouse");
        w.addProduct(p3);
        w.addProduct(p1);
        //w.addProduct(p1);
        w.addProduct(p2);
        //p1.addMoreProduct(100);

        System.out.println(w.allNames());
        System.out.println(w.allProducts());
        
        System.out.println("" + w.getWarehouseName() + ": Contains " + p1.toString() + " ? " + w.containsProduct(p1));
        System.out.println("Quantity of " + p1.getName() + " is: " + w.getQuantity(p1.getName()));
        System.out.println("");
